                            ...
                            <div className="col-lg-9 favourites-table col-sm-12">
                                ...
                                <table className="table">
                                    <thead>
                                        ...
                                        <th scope="col"><span onClick={this.sortPopularityDesc}><i className="fas fa-sort-up"/></span>Popularity<span onClick={this.sortPopularityAsc}><i className="fas fa-sort-down"/></span></th>
                                        <th scope="col"><span onClick={this.sortRatingDesc}><i className="fas fa-sort-up" ></i></span>Rating<span onClick={this.sortRatingAsc}><i className="fas fa-sort-down"></i></span></th>
                                        <th scope="col"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
